...
int main(int argc, char** argv) {
    ...
    float finish;
    const int SIZE=16;
    char cHand[SIZE], //Player 1 unique color per card [0-7], Player 2 unique color per card [8-15]
         display[SIZE], //To display the color of the card for player 1 & 2.
         choice,  //choice to continue the game or not?
         cTemp;   //variable to assign beginning starting hands
    int  iHand[SIZE], //Player 1 unique number per card[0-7],  Player 2 unique number per card [8-15]
         palet[SIZE],  //Player 1 cin value choice[0-7], player 2 cin value choice [8-15]
         random[SIZE], //to set random numbers to assign cards, temp values
//         random1, unnecessary---put in function   //use temp values from random[16];
         color[SIZE], //To possibly validate user cards and have them resubmit if wrong
         cPalet[SIZE], //Player 1 cin color choice[0-7], player 2 cin color choice [8-15]
         canvas[SIZE], //Player 1 cin canvas change choice[0-7], player 2 cin canvas change choice [8-15]
         ...
         turn; //To determine who's turn it is
    string hand[SIZE],  //Displays starting player 1 hand[0-7], displays player 2 starting hand [8-15]
           victor=""; 
