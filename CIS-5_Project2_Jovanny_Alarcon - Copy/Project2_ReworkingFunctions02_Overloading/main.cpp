...
void plyrTrn(char a[], int b[], char c[], int d[], int &,int = 0, int = 7);
...
//         iTemp, tempCol; //variables to assign beginning starting hands
    ...
    do{
        ...
        if (turn % 2 == 1)
        plyrTrn(display, palet, canvas, cPalet, canvas1);
        else if (turn %2 == 0)
...
void plyrTrn(char a[], int b[], char c[], int d[], int &canvas,int start, int end){
